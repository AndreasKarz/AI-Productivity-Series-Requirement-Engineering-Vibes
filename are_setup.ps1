...
# Installiert: Git, Az Module, VS Code Insiders, Node.js und Extensions
...
# 1. Git Installation prüfen oder auf Benutzerebene installieren
Write-Status "Prüfe Git Installation..."
$gitBasePath = Join-Path $env:USERPROFILE "Apps\Git"
